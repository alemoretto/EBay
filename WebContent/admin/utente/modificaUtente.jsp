...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/utente/ExecuteModificaUtenteServlet" method="post">
		...
		<c:if test="${messaggiDiErrore.ruoloInput != null}">
			...
			<c:forEach items="${listRuoliAttribute}" var="ruoloItemLista">
				...
				<c:forEach items="${utenteDTOAttribute.ruoli}" var="ruolo">
					...
					</c:forEach>> ${ruoloItemLista.descrizione}<br>
			</c:forEach>
<br>
			<div class="form-group">
